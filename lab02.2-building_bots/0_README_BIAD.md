...
- [1_Dialogs_and_Regex](./1_Dialogs_and_Regex_BIAD.md): Here you will build a bot that uses Regex to act on user input and learn about using dialog containers for organizing bots.
